...
/**
 * @Desc:处理内容工具：把原始内容处理成json格式
 * @Auther: dengyanliang
 * @Date: 2020/4/9 16:25
 */
public class DealwithContentUtil {

    private static final String CONTENT_BEGIN = "[";
    private static final String CONTENT_END = "]";

    private static final String CONTENT_TYPE_BEGIN = "{\"type\":\"text\",\"content\":\"";
    private static final String CONTENT_TYPE_END = "\"}";

    private static final String LINK_TYPE_BEGIN = "{\"type\": \"link\",\"content\": \"";
    private static final String LINK_TYPE_MIDDLE = "\",\"props\": {\"href\": ";
    private static final String LINK_TYPE_END = "\"}}";
    ...
    public static String processToJson(String content) {
        ...
        contentBuffer.append(CONTENT_BEGIN);
        contentBuffer.append(content);
        contentBuffer.append(CONTENT_END);
    ...
    private static String setLink(String url){
        ...
        StringBuffer buffer = new StringBuffer(200);
        buffer.append(LINK_TYPE_BEGIN);
        buffer.append(url);
        buffer.append(LINK_TYPE_MIDDLE);
        buffer.append(url);
        buffer.append(LINK_TYPE_END);
    ...
    private static String setText(String text){
        ...
        StringBuffer buffer = new StringBuffer(200);
        buffer.append(CONTENT_TYPE_BEGIN);
        buffer.append(text);
        buffer.append(CONTENT_TYPE_END);
