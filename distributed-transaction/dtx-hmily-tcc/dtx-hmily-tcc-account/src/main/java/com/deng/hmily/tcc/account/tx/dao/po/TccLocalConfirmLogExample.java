package com.deng.hmily.tcc.account.tx.dao.po;

import java.util.ArrayList;
import java.util.Date;
import java.util.List;

public class TccLocalConfirmLogExample {
    /**
     * tcc_local_confirm_log
     */
    ...
    public TccLocalConfirmLogExample() {
